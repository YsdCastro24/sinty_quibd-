...
function SearchResults() {
  ...
  // Verificar si state existe y contiene field y time
  if (!state || !state.field || !state.time) {
    navigate("/"); // Redirigir a la página principal o a la página de búsqueda
    return null;
  }
  ...
  const fieldsData = {
    "Sau Pablo": { img: "./img/sau_pablo.png", attributes: ["Césped natural", "Iluminación"], price: "$90,000.00 por hora" },
    "Citara": { img: "./img/citara.png", attributes: ["Césped sintético", "Iluminación"], price: "$85,000.00 por hora" },
    "Bernabéu": { img: "./img/bernabeu.png", attributes: ["Césped sintético", "Graderías"], price: "$100,000.00 por hora" },
    "A otro nivel": { img: "./img/a_otro_nivel.png", attributes: ["Césped sintético", "Cancha techada"], price: "$95,000.00 por hora" },
    "Chipi chipi": { img: "./img/chipi_chpi.png", attributes: ["Césped sintético", "Iluminación"], price: "$80,000.00 por hora" },
  };
        ...
        <div className="flex flex-col sm:flex-row items-center border-b pb-4 mb-4">
          ...
          <div className="text-center sm:text-left">
            ...
            {selectedFieldData.attributes.map((attribute, index) => (
              <p key={index} className="bg-gray-200 rounded-lg text-gray-600 py-1 px-2 inline-block mb-2">
                {attribute}
              </p>
            ))}
