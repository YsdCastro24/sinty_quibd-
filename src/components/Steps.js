    ...
    <div className="bg-gray-200 p-8 my-8 rounded-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="text-2xl font-semibold text-center">
          <img className="mx-14 mb-1 animate-rubber-band"  src="/calendario.png" alt="Paso 1" />
          <h2 className="rotate-[-5deg] mb-8">Selecciona <br/> Fecha y Hora</h2>
        </div>
        <div className="text-2xl font-semibold text-center">
          <img src="/cancha.png" alt="Paso 2" className="mx-14 mb-1 animate-rubber-band" />
          <h2 className="rotate-[-5deg] mb-8">Elige la cancha <br /> de tu preferencia</h2>
        </div>
        <div className="text-2xl font-semibold text-center">
          <img src="/costo.png" alt="Paso 3" className="mx-14 mb-1 animate-rubber-band" />
