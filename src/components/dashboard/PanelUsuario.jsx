  ...
  return (
    <div className="flex flex-col md:flex-row h-screen">
      <aside className="bg-gray-300 w-full md:w-1/4 p-4 flex flex-col items-center">
        ...
        <button className="bg-[#0F4767] text-black text-2xl font-bold py-2 px-4 rounded mb-4 w-full">Reservas</button>
        <button className="bg-[#0F4767] text-black text-2xl font-bold py-2 px-4 rounded mb-4 w-full">Registro <br /> Jugadores</button>
      </aside>
